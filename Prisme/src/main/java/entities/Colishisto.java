...
/**
 * The persistent class for the colishisto database table.
 * 
 */
@Entity
@NamedQuery(name="Colishisto.findAll", query="SELECT c FROM Colishisto c")
public class Colishisto implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy=GenerationType.IDENTITY)
	private int idColisHisto;
	...
	public int getIdColisHisto() {
		return this.idColisHisto;
	}

	public void setIdColisHisto(int idColisHisto) {
		this.idColisHisto = idColisHisto;
	}
